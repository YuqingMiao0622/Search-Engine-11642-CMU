...
//    System.out.println("operator name: " + operatorNameLowerCase);
...
//      System.out.println("query string: " + queryString);
    ...
    String[] substrings = queryString.split("[(]", 2);  // limit(2) constrains the length of the array.
...
//    System.out.println("substring 0: " + substrings[0]);
//    System.out.println("queryString: " + queryString);
    ...
    String op = substrings[0].toLowerCase().trim();
//    System.out.println("op: " + op);
    while (queryString.length() > 0) {
      ...
      //  this loop must handle "weight arg".  Handle the weight first.
        if (op.equals("#wand") || op.equals("#wsum")) {
//            List<Double> weights = new ArrayList<Double>();
            String[] queryTerms = queryString.split(" ", 2);
            queryTree.weights.add(Double.parseDouble(queryTerms[0]));
            queryString= queryTerms[1];
...
//        System.out.println("char 0: " + queryString.charAt(0));
...
//	  System.out.println("get popped: " + p.getPopped());
	  qargs = createTerms (p.getPopped());
      }

      queryString = p.getRemaining().trim();	// Consume the arg
//      System.out.println("remaining: " + queryString);
